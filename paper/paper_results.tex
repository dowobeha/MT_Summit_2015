...
%
%%
%The raters were presented with blocks of twelve lines arranged in a vertical list: the first line was a source segment, and below these were the twelve translations for the segment listed in random order.
%%
...
Figure \Vref{fig:mean_ger} \vpageref[above]{fig:mean_ger} shows GER for Spanish-English.
%
...
%
%
%INSERT REF TO FIG 7 AND INSERT FIG 7
%
